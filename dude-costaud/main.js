function init(parent) {
	...
	var game = new Phaser.Game(1150, 780, Phaser.CANVAS, parent, state, false, false);
	...
	function create() {
		...
		bg = game.add.tileSprite(0, 0, 1024, 768, 'background');
		...
		var groundPlayerCM = game.physics.p2.createContactMaterial(spriteMaterial, worldMaterial, {
			friction : 0.0
		});
		var groundBoxesCM = game.physics.p2.createContactMaterial(worldMaterial, boxMaterial, {
			friction : 0.6
		});
		...
		text = game.add.text(20, 20, 'move with arrow, space to jump', {
			fill : '#ffffff'
		});
